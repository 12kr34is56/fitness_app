...
interface trainerSchema  
  { name: string | null; image: string | null; email: string; }
const UserInfoExtra = () => {
  ...
  return (
    <Form {...form}>
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
        <h1 className="text-4xl mt-10 bg-gray-100 shadow-xl dark:bg-gray-800 dark:text-stone-300 text-slate-600 p-2 rounded-xl mx-2 mb-20 font-bold text-center">Enter Your Information</h1>
        ...
        />
        {isSubmitting && <p className="text-blue-500">Updating user information...</p>} 
        <Button type="submit" className="w-full" disabled={isSubmitting}>Proceed</Button> 
      </form>
    </Form>
  )
}
